...
test("website/lib/audit/patterns.ts matches the canonical audit patterns module", () => {
  const canonical = readFileSync(path.join(repoRoot, "packages/hig-doctor/src-termcast/src/patterns.ts"), "utf8")
  const websiteCopy = readFileSync(path.join(repoRoot, "website/lib/audit/patterns.ts"), "utf8")
