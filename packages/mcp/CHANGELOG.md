...
- Consume the canonical core package without a separately maintained website
  audit engine or rule catalog.
- Add a Codex packaging recipe that starts this exact release through `npx`.
